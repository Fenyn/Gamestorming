...
/// <summary>
/// Maps a creature slug (<see cref="Bulwark.Data.CreatureRef.Slug"/>) to its combat sprite folder,
...
///
/// ASSET REALITY (2026-07): the only combat sprites that exist are three rat variants under
...
/// including the Dire Wolf quest-9 boss. Repoint each row the day its art lands; the call site never
