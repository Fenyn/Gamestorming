...
/// <summary>
/// Registry of joinable PC presets (the code half of a recruitable villager). SHIPPED EMPTY:
/// authoring a new playable villager means authoring its PC preset the way
