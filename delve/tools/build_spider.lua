...
local swatches={m='9d775e',s='654b3d',d='302b29',l='ccb18b',o='201e1c',c='e4d8b6',e='ffca66'}
...
local function pose(dx,dy,frontLift)
 ...
 for n,chain in ipairs(legs) do
  ...
  line(im,a,b,near and 2 or 1.5,1.6,'s')
  line(im,b,c,1.6,.6,'s')
  if near then
   -- Deep shade belongs at the body overlap, not along the whole upper leg.
   line(im,a,{a[1]+(b[1]-a[1])*.24,a[2]+(b[2]-a[2])*.24},1.2,.8,'d')
 ...
 polygon(abdomen,moved({{11,22},{15,24},{20,26},{26,28},{31,27},{35,24},{36,27},{32,32},{24,34},{16,31},{11,26}},dx,dy),'s')
 polygon(abdomen,moved({{16,15},{25,14},{27,15},{24,16},{18,17}},dx,dy),'l')
 polygon(abdomen,moved({{20,31},{25,32},{30,30},{35,26},{36,27},{32,32},{24,34}},dx,dy),'d')
 local head=ims[6]
 ...
 polygon(head,moved({{39,33},{44,34},{49,32},{50,34},{46,36},{42,35}},dx,dy),'d')
 local mouth=ims[11]
