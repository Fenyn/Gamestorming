...
local swatches={m='997055',s='6a4b3b',d='3e3028',l='bf9470',o='201e1c',c='e4d8b6',e='ffca66'}
...
local function pose(dx,dy,frontLift)
 ...
 polygon(abdomen,moved({{29,31},{33,29},{35,26},{36,27},{32,32},{28,33}},dx,dy),'d')
 local head=ims[6]
 ...
 polygon(head,moved({{44,34},{49,32},{50,34},{46,36},{44,36}},dx,dy),'d')
