...
@export var plant_cost_type: String = "mana"
@export var growth_ticks: int = 50
@export var growth_mode: String = "passive"
...
@export var unlock_vitality: float = 0.0
@export var tithe_options: PackedFloat64Array = []
@export var tithe_threshold: float = 10000.0
