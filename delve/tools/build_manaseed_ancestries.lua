...
local configs={
 ...
 {name='elara',slots={'0bas','1out','4har'},remove={},repeatRows={[29]=true,[37]=true},pad=-2},
 {name='tharr',slots={'0bas','1out','4har'},remove={[30]=true,[36]=true,[40]=true},repeatRows={},pad=3},
 -- Retain more torso/leg length; reduce the head/hat as well as the body.
 {name='fenwick',slots={'0bas','1out','5hat'},remove={[16]=true,[18]=true,[28]=true,[31]=true,[37]=true,[40]=true},repeatRows={},pad=6},
}
...
local function sxFor(c,x,sy,face)
 ...
 if c.name=='tharr' then
  ...
  if sy<25 then scale=1.04 elseif sy<36 then scale=face<2 and 1.22 or 1.16 else scale=1.08 end
 elseif c.name=='fenwick' then
  if sy<26 then scale=.84 elseif sy>=42 then scale=1.10 else scale=1 end
